...
function genLink($content)
{
    ...
    if (!empty($type[1])) {
            ...
            $outgoing = '
                {
                    "replies": [
                        {
                            "message": "*Tautan instagram berhasil diproses!*\\n\\n*Author :* '.$author[1].'\\n*Caption :* '.$caption[1].'\\n*Tipe media :* video\\n*Like :* '.$like[1].'\\n*Comment :* '.$comment[1].'\\n*Link video :* '.$videourl[1].'"
                        }
                    ]
                }
            ';
        ...
        $outgoing = '
        {
            "replies": [
                {
                    "message": "*Kesalahan! Media tidak ditemukan*\\nKemungkinan profil ini bersifat private atau bukan untuk publik"
                }
            ]
        }
        ';
